	...
	<div id="modulecontent" class="clearfix {if $ps_version_bo >= '1.7.8'}new{/if}">
		...
		<div class="col-lg-2">
			<div class="list-group">
				...
				<a href="#zones" class="menu_tab list-group-item {if $tab == 6}active{/if}" data-toggle="tab"><i class="icon-map-marker"></i> {l s='Delivery Zones' mod='prestatillhomedelivery'}</a>
		...
		<div class="tab-content col-lg-10">
			<div class="tab-pane panel col-md-12 tab_padd_12 {if $tab == 6}active{/if}" id="zones">
				<div class="col-md-12">
					{include file="./tabs/zones.tpl"}
				</div>
			</div>
		</div>
