...
<div class="alert alert-info">
	...
	<strong>{l s='NEW! Zone-based delivery system available' mod='prestatillhomedelivery'}</strong><br />
	{l s='You can now use a zone-based delivery system instead of distance or postal codes. Go to the "Delivery Zones Management" tab to configure delivery zones on a map.' mod='prestatillhomedelivery'}
	<br /><br />
	<a href="#zones_management" class="btn btn-primary btn-sm menu_tab" data-toggle="tab">
		<i class="icon-map-marker"></i> {l s='Configure Delivery Zones' mod='prestatillhomedelivery'}
	</a>
</div>
