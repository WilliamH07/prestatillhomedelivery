...
<div class="alert alert-danger">
    ...
    <br />
    {l s='Please configure your Google Maps API Key in the "Parameters" tab to use the delivery zones management.' mod='prestatillhomedelivery'}
    <br />
...
<script>
    var zonesManagementData = {
        apiKey: '{$gg_api_key|escape:'javascript':'UTF-8'}',
        stores: {if !empty($stores)}{json_encode($stores)}{else}[]{/if},
        carriers: {if !empty($carriers)}{json_encode($carriers)}{else}[]{/if},
