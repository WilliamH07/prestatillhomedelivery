...
var ZonesManagement = (function() {
    ...
    var shapes = {};
    var infoWindow;
    var defaultCenter = { lat: 48.8566, lng: 2.3522 }; // Paris par défaut
    ...
    function displayZonesOnMap(zonesData) {
        ...
        zonesData.forEach(function(zone) {
            ...
            try {
                ...
                console.error('Original zone data:', zone.zone_data);
    ...
    function getCarrierName(idCarrier) {
        if (idCarrier == 0) return 'All carriers';
...
$(document).ready(function() {
    if (typeof zonesManagementData !== 'undefined' && zonesManagementData.apiKey) {
